const LS_KEYS = {
    ...
    MERGE: 'sc_g_merge',
    TOL: 'sc_g_tol',
    DIR_THUMB_SIZE: 'sc_dir_thumb_size',
    API_KEY: 'sc_api_key',
    MODEL: 'sc_model',
...
const state = {
    ...
    directoryThumbSize: parseInt(localStorage.getItem(LS_KEYS.DIR_THUMB_SIZE) || '220', 10),
...
const DOM = {
    ...
    directoryModalBody: document.getElementById('directoryModalBody'),
    directoryThumbSize: document.getElementById('directoryThumbSize'),
    directoryThumbSizeValue: document.getElementById('directoryThumbSizeValue'),
